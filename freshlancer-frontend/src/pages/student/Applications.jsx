...
const Applications = () => {
  ...
  const [activeTab, setActiveTab] = useState('active'); // 'active' or 'withdrawn'
  ...
  const activeApplications = useMemo(
    () => allApplications.filter((app) => app.status !== 'withdrawn'),
    [allApplications]
  );
  ...
  const applications = activeTab === 'active' ? activeApplications : withdrawnApplications;
            ...
            <div className="border-b border-gray-200">
              <nav className="-mb-px flex space-x-8">
                ...
                >
                  ...
                  Withdrawn Applications ({withdrawnApplications.length})
                </button>
              </nav>
            </div>
          </div>
